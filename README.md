...
Please check out [regexgen.js](app/scripts/regexgen.js) and [wiki](wiki.md) for API documentations, and check out [test.js](test/spec/test.js) for more examples.
